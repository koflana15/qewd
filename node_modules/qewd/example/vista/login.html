...
<div class="modal-dialog">
  <div id="loginModalPanel" class="modal-content">
    <div class="modal-header">
      <h3 id="ewd-loginPanel-title">VistA Authentication</h3>
    </div>
	<div id="loginIntro" class="modal-body" style=""></div>
    ...
    <div class="modal-footer">
	  <div class="checkbox login">
	  	<label for="chkChangeVerify">Change Verify Code?
		<input type="checkbox" id="chkChangeVerify">
		</label>
	  </div>
