...
server {
	...
	server_name _;
       ...
       # Proxy all non-static content via QEWD
       ...
       # /instances fetches images from Dicom server at demo.rippleosi.org

       location  /instances/  {
          proxy_pass http://demo.rippleosi.org:8042;
          proxy_set_header HOST $host;
...
server {
	...
	server_name _;
       ...
       # /api-docs points to Swagger
       location /api-docs {
          proxy_pass https://localhost:8081/api-docs;
       }	
